      ...
      >
        <div className="author-list">
          {data.authors.slice(0, 6).map((author, index) => (
            ...
            >
              <Link to={`/authors/${author.slug}`} className="flex bg-white shadow-lg w-80 md:w-100 cursor-pointer mt-5 hover:shadow-blue-300/50 transition-all duration-300 h-20 pl-5 py-4 rounded-2xl">
